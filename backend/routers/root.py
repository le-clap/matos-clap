...
# from models.models import Availability, Item, Catalog, Category, Condition, User
#
...
#     return None
#
# @app.delete("/item/{item_id}/soft-delete", response_model=Item)
...
#     return item
#
# @app.delete("/item/{item_id}/soft-undelete", response_model=Item)
